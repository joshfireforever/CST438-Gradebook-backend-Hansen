...
public class JunitTestGradebook {
	...
	public void addAssignment() throws Exception {
		...
		response = mvc.perform(MockMvcRequestBuilders.post("/gradebook?due=2021-09-01&name=NewTestAssignment&courseId=40442").accept(MediaType.APPLICATION_JSON)).andReturn().getResponse();
	...
	//test deleting an assignment
		...
		public void deleteAssignment() throws Exception {
			...
			verify(assignmentGradeRepository, times(1)).delete(any());
			
		}
	
		//test renaming an assignment
		@Test
		public void renameAssignment() throws Exception {
			...
			//create a new assignment
			response = mvc.perform(MockMvcRequestBuilders.put("/gradebook/1/Test_Rename").accept(MediaType.APPLICATION_JSON)).andReturn().getResponse();

			// verify that assignment was modified
